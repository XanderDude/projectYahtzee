...
Public Class frmYahtzee
    ...
    Private Sub frmYahtzeeStartLoad_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        '--------------------------------------------------------------------------------
        ' Description: Load all necessary data. Prepare pnlStartLoad for proper viewing. 
        '              Align all objects in pnlStartMenuTitle.
        '--------------------------------------------------------------------------------

        Dim intSpace As Integer = 10
        btnConfirm.Visible = False
        pnlStartLoad.Visible = True
        ...
        rad1P.Width = CInt((pnlChoosePlayers.Width / 6) - intSpace / 6) '7
    ...
    Private Sub btnRoll_Click(sender As Object, e As EventArgs) Handles btnRoll.Click
        '----------------------------------------------------------------------
        ' Description: Logic for rolling 5 dice, run when pressed.
        '----------------------------------------------------------------------
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        '----------------------------------------------------------------------
        ' Description: Start fresh game with desired number of players(cintPlayerCount)
        '----------------------------------------------------------------------
